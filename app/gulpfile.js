...
gulp.task('sass', function() { // Создаем таск Sass
	return gulp.src(['app/sass/**/*.sass', '!app/sass/libs.sass'])// Берем источник
		.pipe(sourcemaps.init()) // Инициализируем soursemap
		.pipe(sass()) // Преобразуем Sass в CSS посредством gulp-sass
		.pipe(sourcemaps.write()) // Пишем soursemap
...
gulp.task('watch', function() {
	gulp.watch('app/sass/**/*.sass', gulp.parallel('sass')); // Наблюдение за sass файлами и библиотеками
